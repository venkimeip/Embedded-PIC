	...
	; --output=default Adcc.p1 DigIO.p1 main.p1 SW_TIMER.p1 Timerc.p1 \
...
;	12 bytes of RAM objects in bank 0 to zero

	psect	init
	global	__Lrbss_0
	movlw	low(__Lrbss_0)		;load the low address into FSR
	movwf	FSR
	movlw	low(__Lrbss_0+12)		;load the high address+1 into W
